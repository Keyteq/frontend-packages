...
const ModalExample = () => (
  <Styleguide
    ...
    <p>
      ...
      pagescroll, scroll på content, focus-trap samt ESC-exit. Krever at minst
      ett child-element er focusable. Animasjon inn/ut, størrelser og bakgrunn
      kan enkelt endres ved behov. Tar også onOpen og onClose som functions via
      props.
    </p>
    <h3>Enkel versjon:</h3>
              ...
              {onClose2 => (
                <Fragment>
                  ...
                  <ModalBody>
                    ...
                    <p>
                      All logikk håndteres automagisk! Trykk lukk, trykk utenfor
                      modal eller lukk med ESCAPE-knappen
                    </p>
                  </ModalBody>
                </Fragment>
              )}
    ...
    <p>
      ...
      wrapperFunctionForButton. Nyttig når man skal ha Modal på en komponent som
      feks {`<Tooltip />`}
    </p>
    <Modal
