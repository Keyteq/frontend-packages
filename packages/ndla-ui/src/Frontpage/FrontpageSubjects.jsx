  ...
  const getItems = (disable = false) =>
    subjects.map(subject => (
      <li key={subject.url} {...sectionClasses('item')}>
        ...
        <FrontpageMenuitemExtention to={subject.url} subLinks={subject.subLinks}>
        ...
        {subject.beta &&
          <Modal
            ...
            activateButton={
              <Button lighter {...sectionClasses('beta-label')} aria-label={t('subjectPage.subjectIsBeta.dialogHeader')}>
...
export class FrontpageSubjects extends Component {
  ...
  setScreenSize() {
    const isNarrowScreen = (window.innerWidth || document.documentElement.clientWidth) < 601;
