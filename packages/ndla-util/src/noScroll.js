...
const noScroll = (enable, uuid) => {
  ...
  if (enable) {
    if (!scrollTargets.includes(uuid)) {
      ...
      document.querySelector('.c-masthead--fixed').style.paddingRight = `${scrollWidth}px`;
    ...
    if (scrollTargets.length === 0) {
      ...
      document.querySelector('.c-masthead--fixed').style.paddingRight = 0;
